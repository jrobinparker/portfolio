  ...
  return (
    <div className="experience-matrix fadein">
      <div style={{ fontSize: '2rem' }}>
        <i class="far fa-chart-bar about-me-icon" style={{ fontSize: '5rem' }} />
      ...
      <div className="box">
        <ul style={{ fontSize: '1rem' }}>
          <li>as the LMS system admin, I develop training content and site pages, manage sitewide CSS styles, create email notification templates, and provision new users</li>
